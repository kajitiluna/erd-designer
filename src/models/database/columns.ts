...
const databaseColumns: { [key in DatabaseType]: ColumnType[] } = {
    ...
    "postgres": [
        ...
        new ColumnType({ id: 35, name: 'decimal', description: '精度の選択可能な高精度数値', baseQuery: 'DECIMAL', withPrecision: false, withScale: false }),
        new ColumnType({ id: 36, name: 'numeric', description: '精度の選択可能な高精度数値', baseQuery: 'NUMERIC', withPrecision: false, withScale: false }),
        new ColumnType({ id: 45, name: 'decimal (p, s)', description: '精度の選択可能な高精度数値', baseQuery: 'DECIMAL[[PARAM]]', withPrecision: true, withScale: true }),
        new ColumnType({ id: 46, name: 'numeric (p, s)', description: '精度の選択可能な高精度数値', baseQuery: 'NUMERIC[[PARAM]]', withPrecision: true, withScale: true }),
    ...
    "mysql": [
        ...
        new ColumnType({ id: 10, name: 'tinyint', description: '非常に小さい整数。 符号付きの範囲は -128 から 127 です。 符号なしの範囲は 0 から 255 です。', baseQuery: 'TINYINT', withPrecision: false, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 11, name: 'smallint', description: '小さい整数。 符号付きの範囲は -32768 から 32767 です。 符号なしの範囲は 0 から 65535 です。', baseQuery: 'SMALLINT', withPrecision: false, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 13, name: 'mediumint', description: '中間サイズの整数。 符号付きの範囲は -8388608 から 8388607 です。 符号なしの範囲は 0 から 16777215 です。', baseQuery: 'MEDIUMINT', withPrecision: false, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 15, name: 'int', description: '普通サイズの整数。 符号付きの範囲は -2147483648 から 2147483647 です。 符号なしの範囲は 0 から 4294967295 です。', baseQuery: 'INT', withPrecision: false, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 17, name: 'bigint', description: '大きい整数。 符号付きの範囲は -9223372036854775808 から 9223372036854775807 です。 符号なしの範囲は 0 から 18446744073709551615 です。', baseQuery: 'BIGINT', withPrecision: false, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 20, name: 'tinyint (m)', description: '非常に小さい整数。 符号付きの範囲は -128 から 127 です。 符号なしの範囲は 0 から 255 です。', baseQuery: 'TINYINT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: true, withAutoIncrement: false }),
        new ColumnType({ id: 21, name: 'smallint (m)', description: '小さい整数。 符号付きの範囲は -32768 から 32767 です。 符号なしの範囲は 0 から 65535 です。', baseQuery: 'SMALLINT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 23, name: 'mediumint (m)', description: '中間サイズの整数。 符号付きの範囲は -8388608 から 8388607 です。 符号なしの範囲は 0 から 16777215 です。', baseQuery: 'MEDIUMINT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 25, name: 'int (m)', description: '普通サイズの整数。 符号付きの範囲は -2147483648 から 2147483647 です。 符号なしの範囲は 0 から 4294967295 です。', baseQuery: 'INT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 27, name: 'bigint (m)', description: '大きい整数。 符号付きの範囲は -9223372036854775808 から 9223372036854775807 です。 符号なしの範囲は 0 から 18446744073709551615 です。', baseQuery: 'BIGINT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: true, withAutoIncrement: true }),
        new ColumnType({ id: 31, name: 'float', description: '小さい (単精度) 浮動小数点数。 許可される値は、-3.402823466E+38 から -1.175494351E-38、0、および 1.175494351E-38 から 3.402823466E+38 です。', baseQuery: 'FLOAT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: true }),
        new ColumnType({ id: 33, name: 'double', description: '普通サイズ (倍精度) の浮動小数点数。 許可されている値は、-1.7976931348623157E+308 から -2.2250738585072014E-308、0、および 2.2250738585072014E-308 から 1.7976931348623157E+308 です。', baseQuery: 'DOUBLE', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: true }),
        new ColumnType({ id: 35, name: 'decimal', description: '固定小数点数。 桁数10 (精度) で、小数点以下の桁数0です。', baseQuery: 'DECIMAL', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: true }),
        new ColumnType({ id: 36, name: 'numeric', description: 'DECIMAL のシノニムです。固定小数点数。 桁数10 (精度) で、小数点以下の桁数0です。', baseQuery: 'NUMERIC', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: true }),
        new ColumnType({ id: 41, name: 'float (m, d)', description: '小さい (単精度) 浮動小数点数。 許可される値は、-3.402823466E+38 から -1.175494351E-38、0、および 1.175494351E-38 から 3.402823466E+38 です。', baseQuery: 'FLOAT[[PARAM]]', withPrecision: true, withScale: true, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 42, name: 'float (p)', description: '浮動小数点数です。p は精度をビットで表現します。', baseQuery: 'FLOAT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 43, name: 'double (m, d)', description: '普通サイズ (倍精度) の浮動小数点数。 許可されている値は、-1.7976931348623157E+308 から -2.2250738585072014E-308、0、および 2.2250738585072014E-308 から 1.7976931348623157E+308 です。', baseQuery: 'DOUBLE[[PARAM]]', withPrecision: true, withScale: true, withUnsigned: false, withAutoIncrement: false }),
        ...
        new ColumnType({ id: 101, name: 'date', description: '日付です。 サポートしている範囲は "1000-01-01" から "9999-12-31" です。', baseQuery: 'DATE', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false, defaultValueCandidates: ['(CURRENT_DATE)'] }),
        new ColumnType({ id: 131, name: 'time', description: '時間です。 範囲は、"-838:59:59.000000" から "838:59:59.000000" です。', baseQuery: 'TIME', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false, defaultValueCandidates: ['(CURRENT_TIME)'] }),
        new ColumnType({ id: 141, name: 'time (p)', description: '時間です。 範囲は、"-838:59:59.000000" から "838:59:59.000000" です。', baseQuery: 'TIME[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false, defaultValueCandidates: ['(CURRENT_TIME)'] }),
        ...
        new ColumnType({ id: 321, name: 'tinytext', description: '最大長が 255 文字の TEXT カラム。', baseQuery: 'TINYTEXT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 322, name: 'text', description: '最大長が 65,535 文字の TEXT カラム。', baseQuery: 'TEXT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 323, name: 'text (m)', description: '最大長が 65,535 文字の TEXT カラム。', baseQuery: 'TEXT[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 324, name: 'mediumtext', description: '最大長が 16,777,215 文字の TEXT カラム。', baseQuery: 'MEDIUMTEXT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 325, name: 'longtext', description: '最大長が 4G 文字の TEXT カラム。', baseQuery: 'LONGTEXT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 3, name: 'binary (m)', description: 'バイナリバイト文字列を格納します。', baseQuery: 'BINARY[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 5, name: 'varbinary (m)', description: 'バイナリバイト文字列を格納します。', baseQuery: 'VARBINARY[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 361, name: 'tinyblob', description: '最大長が 255 バイトの BLOB カラム。', baseQuery: 'TINYBLOB', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 363, name: 'blob', description: '最大長が 65,535 バイトの BLOB カラム。', baseQuery: 'BLOB', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 364, name: 'blob (m)', description: '最大長が 65,535 バイトの BLOB カラム。', baseQuery: 'BLOB[[PARAM]]', withPrecision: true, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 365, name: 'mediumblob', description: '最大長が 16,777,215 バイトの BLOB カラム。', baseQuery: 'MEDIUMBLOB', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 367, name: 'longblob', description: '最大長が 4G バイトの BLOB カラム。', baseQuery: 'LONGBLOB', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 422, name: 'json', description: '文書の型式であるJSONデータを格納するために使用されるデータ型。', baseQuery: 'JSON', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2001, name: 'geometry', description: '空間データを格納するために使用されるデータ型。点、線、多角形、およびその他の形状を含めることができます。', baseQuery: 'GEOMETRY', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2011, name: 'point', description: 'GEOMETRYデータ型の1つであり、2次元空間上の単一の点を表します。', baseQuery: 'POINT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2012, name: 'linestring', description: 'GEOMETRYデータ型の1つであり、2次元空間上の複数の点を結ぶ直線セグメントの連続したセットを表します。', baseQuery: 'LINESTRING', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2013, name: 'polygon', description: 'GEOMETRYデータ型の1つであり、2次元平面上の単一の領域を表す閉じたループの集合です。', baseQuery: 'POLYGON', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2021, name: 'multipoint', description: 'GEOMETRYデータ型の1つであり、複数の点を表す複数のPOINTオブジェクトの集合です。', baseQuery: 'MULTIPOINT', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2022, name: 'multilinestring', description: 'GEOMETRYデータ型の1つであり、複数の線分を表す複数のLINESTRINGオブジェクトの集合です。', baseQuery: 'MULTILINESTRING', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2023, name: 'multipolygon', description: 'GEOMETRYデータ型の1つであり、複数のポリゴンを表す複数のPOLYGONオブジェクトの集合です。', baseQuery: 'MULTIPOLYGON', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
        new ColumnType({ id: 2031, name: 'geometrycollection', description: 'GEOMETRYデータ型の1つであり、複数のGEOMETRYオブジェクトの集合を表します。', baseQuery: 'GEOMETRYCOLLECTION', withPrecision: false, withScale: false, withUnsigned: false, withAutoIncrement: false }),
